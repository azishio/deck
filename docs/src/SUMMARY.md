...
- [Install and create a deck](./getting-started.md)
- [The project layout](./layout.md)
...
- [Assets, fonts and the cursor](./assets.md)
- [Animation](./animation.md)

# Delivering

- [Presenting and printing](./presenting.md)
- [Checking](./checking.md)
- [Static build and deployment](./deploying.md)
